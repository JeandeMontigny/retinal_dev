...
//  mySeed = 9784;  // 9784
  ...
  CellCreator<MyCell>(param->min_bound_, param->max_bound_, 30, 0); // on
  CellCreator<MyCell>(param->min_bound_, param->max_bound_, 30, 1); // off
  CellCreator<MyCell>(param->min_bound_, param->max_bound_, 30, 2); // on-off
